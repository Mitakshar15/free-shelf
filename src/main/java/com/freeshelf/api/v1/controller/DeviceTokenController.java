...
public class DeviceTokenController {
    ...
    public ResponseEntity<NotificationResponse> registerDeviceToken(
        ...
        boolean success = pushNotificationService.registerDeviceToken(
                user, 
                request.getToken(), 
        ...
        NotificationResponse response = NotificationResponse.builder()
                .message(Map.of(
                        ...
                        "message", success ? "Device registered successfully" : "Failed to register device"
                ))
                .build();
    ...
    public ResponseEntity<NotificationResponse> unregisterDeviceToken(
