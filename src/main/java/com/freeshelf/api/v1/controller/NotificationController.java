...
public class NotificationController {
  ...
  public ResponseEntity<NotificationResponse> getUserNotifications(
    ...
    NotificationResponse response = NotificationResponse.builder().notifications(notifications)
  ...
  public ResponseEntity<NotificationResponse> getUnreadNotificationCount(
    ...
    NotificationResponse response = NotificationResponse.builder().unreadCount(count).build();
  ...
  public ResponseEntity<NotificationResponse> markNotificationAsRead(
    ...
    NotificationResponse response = NotificationResponse.builder()
        .notifications(List.of(notification)).unreadCount(unreadCount).build();
  ...
  public ResponseEntity<NotificationResponse> markAllNotificationsAsRead(
    ...
    NotificationResponse response = NotificationResponse.builder().unreadCount(0)
        .message(Map.of("message", "All notifications marked as read")).build();
